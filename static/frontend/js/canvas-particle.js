var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var body = document.getElementsByClassName("blog-body")[0];
		...
		window.addEventListener("resize", function(){canvasSize(canvas.element);}, false);
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementsByClassName("blog-body")[0].style.width;
		var height = document.getElementsByClassName("blog-body")[0].style.height;
